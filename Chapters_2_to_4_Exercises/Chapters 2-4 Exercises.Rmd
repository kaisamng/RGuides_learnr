...
```{r ex-data, include=FALSE, eval= TRUE}
load("ch2_4_data.RData")
```
...
```{r exercise-2, exercise=TRUE, exercise.setup="ex-data", exercise.cap="Exercise 2"}
...
```{r exercise-3, exercise=TRUE, exercise.setup="ex-data", exercise.cap="Exercise 3"}
#1
