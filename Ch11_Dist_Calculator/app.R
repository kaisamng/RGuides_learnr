...
ui <- fluidPage(tags$head(
  tags$script(src="https://cdnjs.cloudflare.com/ajax/libs/iframe-resizer/4.3.2/iframeResizer.min.js",
...
#  headerPanel("Distribution Calculator"),
  ...
  sidebarPanel(
    ...
    br(),
    div(textOutput("model"), align= "center", style = "font-size:120%; font-weight:bold;"),
    ...
    helpText(a(href = "https://github.com/ShinyEd/ShinyEd/tree/master/dist_calc", target = "_blank", "View code"), style = "text-indent:10px;font-size:100%;")
